...
test("ROTATE z", () => {
  ...
  const result = {
    ...
    BACK: [
      [COLOR.B[2], COLOR.B[5], COLOR.B[8]],
      [COLOR.B[1], COLOR.B[4], COLOR.B[7]],
      [COLOR.B[0], COLOR.B[3], COLOR.B[6]],
    ],
    DOWN: [
      [COLOR.R[6], COLOR.R[3], COLOR.R[0]],
      [COLOR.R[7], COLOR.R[4], COLOR.R[1]],
...
test("ROTATE z'", () => {
  ...
  const result = {
    ...
    FRONT: [
      [COLOR.G[2], COLOR.G[5], COLOR.G[8]],
      [COLOR.G[1], COLOR.G[4], COLOR.G[7]],
      [COLOR.G[0], COLOR.G[3], COLOR.G[6]],
    ],
    RIGHT: [
      [COLOR.Y[2], COLOR.Y[5], COLOR.Y[8]],
      [COLOR.Y[1], COLOR.Y[4], COLOR.Y[7]],
    ...
    BACK: [
      [COLOR.B[6], COLOR.B[3], COLOR.B[0]],
      [COLOR.B[7], COLOR.B[4], COLOR.B[1]],
      [COLOR.B[8], COLOR.B[5], COLOR.B[2]],
    ],
    DOWN: [
      [COLOR.O[2], COLOR.O[5], COLOR.O[8]],
      [COLOR.O[1], COLOR.O[4], COLOR.O[7]],
